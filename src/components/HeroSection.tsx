        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="space-y-6">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight">
              Secure Luggage Storage &amp; Package Forwarding Services
            </h1>
            <p className="text-lg md:text-xl opacity-90">
              Store your bags safely, forward your packages efficiently, or pick up your deliveries at your convenience.
            </p>
            <p className="text-xl md:text-2xl font-semibold bg-white/20 p-3 rounded-md inline-block">
              Packages sent starting at just 1,5€/KG!
            </p>
